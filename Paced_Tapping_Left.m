...
% Version :  1.
% Function:  Paced_Tapping_Left GUI
% Author  :  Dr. Safwan Al-Qadhi

%%
function varargout = Paced_Tapping_Left(varargin)
%PACED_TAPPING_LEFT M-file for Paced_Tapping_Left.fig
%      PACED_TAPPING_LEFT, by itself, creates a new PACED_TAPPING_LEFT or raises the existing
%      singleton*.
%
%      H = PACED_TAPPING_LEFT returns the handle to a new PACED_TAPPING_LEFT or the handle to
%      the existing singleton*.
%
%      PACED_TAPPING_LEFT('Property','Value',...) creates a new PACED_TAPPING_LEFT using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to Paced_Tapping_Left_OpeningFcn.  This calling syntax produces a
%
%      PACED_TAPPING_LEFT('CALLBACK') and PACED_TAPPING_LEFT('CALLBACK',hObject,...) call the
%      local function named CALLBACK in PACED_TAPPING_LEFT.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help Paced_Tapping_Left

% Last Modified by GUIDE v2.5 21-Oct-2008 23:38:33
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Paced_Tapping_Left_OpeningFcn, ...
                   'gui_OutputFcn',  @Paced_Tapping_Left_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before Paced_Tapping_Left is made visible.
function Paced_Tapping_Left_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for Paced_Tapping_Left
...
% UIWAIT makes Paced_Tapping_Left wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = Paced_Tapping_Left_OutputFcn(hObject, eventdata, handles)
...
frame = getframe(Paced_Tapping_Left);
...
fclose('all');
disp(' ');
disp('***** END Paced Tapping Left GUI *****');
disp(' ');
disp(' ');
clear all;
