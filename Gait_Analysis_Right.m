...
% Version :  1.
% Function:  Gait_Analysis_Right GUI
% Author  :  Dr. Safwan Al-Qadhi

function varargout = Gait_Analysis_Right(varargin)
%GAIT_ANALYSIS_RIGHT M-file for Gait_Analysis_Right.fig
%      GAIT_ANALYSIS_RIGHT, by itself, creates a new GAIT_ANALYSIS_RIGHT or raises the existing
%      singleton*.
%
%      H = GAIT_ANALYSIS_RIGHT returns the handle to a new GAIT_ANALYSIS_RIGHT or the handle to
%      the existing singleton*.
%
%      GAIT_ANALYSIS_RIGHT('Property','Value',...) creates a new GAIT_ANALYSIS_RIGHT using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to Gait_Analysis_Right_OpeningFcn.  This calling syntax produces a
%
%      GAIT_ANALYSIS_RIGHT('CALLBACK') and GAIT_ANALYSIS_RIGHT('CALLBACK',hObject,...) call the
%      local function named CALLBACK in GAIT_ANALYSIS_RIGHT.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help Gait_Analysis_Right

% Last Modified by GUIDE v2.5 21-Oct-2008 23:12:06

% ---------Autor:   Al-Qadhi  Safwan

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Gait_Analysis_Right_OpeningFcn, ...
                   'gui_OutputFcn',  @Gait_Analysis_Right_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
%% --- Executes just before Gait_Analysis_Right is made visible.
function Gait_Analysis_Right_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for Gait_Analysis_Right
...
% UIWAIT makes Gait_Analysis_Right wait for user response (see UIRESUME)
% uiwait(handles.figure1);

%% --- Outputs from this function are returned to the command line.
function varargout = Gait_Analysis_Right_OutputFcn(hObject, eventdata, handles)
...
frame = getframe(Gait_Analysis_Right);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
GUI_HANDLE=Gait_Analysis_Right();
...
%         close force
    ...
    fclose('all');
    disp(' ');
    disp('***** END Gait Analysis Right GUI *****');
    disp(' ');
    disp(' ');
    clear all;
