...
% Version :  1.
% Function:  Forefoot_tapping GUI
% Author  :  Dr. Safwan Al-Qadhi

function varargout = Forefoot_tapping(varargin)
%FOREFOOT_TAPPING M-file for Forefoot_tapping.fig
%      FOREFOOT_TAPPING, by itself, creates a new FOREFOOT_TAPPING or raises the existing
%      singleton*.
%
%      H = FOREFOOT_TAPPING returns the handle to a new FOREFOOT_TAPPING or the handle to
%      the existing singleton*.
%
%      FOREFOOT_TAPPING('Property','Value',...) creates a new FOREFOOT_TAPPING using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to Forefoot_tapping_OpeningFcn.  This calling syntax produces a
%
%      FOREFOOT_TAPPING('CALLBACK') and FOREFOOT_TAPPING('CALLBACK',hObject,...) call the
%      local function named CALLBACK in FOREFOOT_TAPPING.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help Forefoot_tapping

% Last Modified by GUIDE v2.5 21-Oct-2008 23:27:18
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Forefoot_tapping_OpeningFcn, ...
                   'gui_OutputFcn',  @Forefoot_tapping_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
%% --- Executes just before Forefoot_tapping is made visible.
function Forefoot_tapping_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for Forefoot_tapping
...
% UIWAIT makes Forefoot_tapping wait for user response (see UIRESUME)
% uiwait(handles.figure1);

%% --- Outputs from this function are returned to the command line.
function varargout = Forefoot_tapping_OutputFcn(hObject, eventdata, handles)
...
frame = getframe(Forefoot_tapping);
...
switch Qd
    ...
    case str2
        close(Forefoot_tapping)
        
clear all
clc
fclose('all');
disp(' ');
disp('***** END Forefoot Tapping Analysis GUI *****');
disp(' ');
disp(' ');
clear all;
