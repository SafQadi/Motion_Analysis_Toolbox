...
% It calculates then the phase difference of the motion of the three joints
% and gives the calculated synchornization index R back to be shown in the gait 
% analysis GUI
